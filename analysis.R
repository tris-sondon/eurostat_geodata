...
if (!file.exists("./rdata/NUTS_2013_60M_SH.RData")){
  ...
  if (!file.exists("./rawdata/NUTS_2013_60M_SH/data/NUTS_RG_60M_2013.shp")){
    ...
    shape <- readOGR(dsn = "./rawdata/NUTS_2013_60M_SH/data", layer = "NUTS_RG_60M_2013", verbose=FALSE)
  } else shape <- readOGR(dsn = "./rawdata/NUTS_2013_60M_SH/data", layer = "NUTS_RG_60M_2013", verbose=FALSE)
  shape$id <- rownames(shape@data)
  map.points <- fortify(shape, region = "id")
  map.df <- merge(map.points, shape, by = "id")
  map.df <- arrange(map.df, order)
  NUTS_2013_60M_SH <- map.df
  save(NUTS_2013_60M_SH, file="./rdata/NUTS_2013_60M_SH.RData")
  ...
  if (!file.exists("./rawdata/NUTS_2013_20M_SH/data/NUTS_RG_20M_2013.shp")){
    ...
    shape <- readOGR(dsn = "./rawdata/NUTS_2013_20M_SH/data", layer = "NUTS_RG_20M_2013", verbose=FALSE)
  } else shape <- readOGR(dsn = "./rawdata/NUTS_2013_20M_SH/data", layer = "NUTS_RG_20M_2013", verbose=FALSE)
  shape$id <- rownames(shape@data)
  map.points <- fortify(shape, region = "id")
  map.df <- merge(map.points, shape, by = "id")
  map.df <- arrange(map.df, order)
  NUTS_2013_20M_SH <- map.df
  save(NUTS_2013_20M_SH, file="./rdata/NUTS_2013_20M_SH.RData")
  ...
  if (!file.exists("./rawdata/NUTS_2013_10M_SH/data/NUTS_RG_10M_2013.shp")){
    ...
    shape <- readOGR(dsn = "./rawdata/NUTS_2013_10M_SH/data", layer = "NUTS_RG_10M_2013", verbose=FALSE)
  } else shape <- readOGR(dsn = "./rawdata/NUTS_2013_10M_SH/data", layer = "NUTS_RG_10M_2013", verbose=FALSE)
  shape$id <- rownames(shape@data)
  map.points <- fortify(shape, region = "id")
  map.df <- merge(map.points, shape, by = "id")
  map.df <- arrange(map.df, order)
  NUTS_2013_10M_SH <- map.df
  save(NUTS_2013_10M_SH, file="./rdata/NUTS_2013_10M_SH.RData")
  ...
  if (!file.exists("./rawdata/NUTS_2013_03M_SH/data/NUTS_RG_03M_2013.shp")){
    ...
    shape <- readOGR(dsn = "./rawdata/NUTS_2013_03M_SH/data", layer = "NUTS_RG_03M_2013", verbose=FALSE)
  } else shape <- readOGR(dsn = "./rawdata/NUTS_2013_03M_SH/data", layer = "NUTS_RG_03M_2013", verbose=FALSE)
  shape$id <- rownames(shape@data)
  map.points <- fortify(shape, region = "id")
  map.df <- merge(map.points, shape, by = "id")
  map.df <- arrange(map.df, order)
  NUTS_2013_03M_SH <- map.df
  save(NUTS_2013_03M_SH, file="./rdata/NUTS_2013_03M_SH.RData")
  ...
  if (!file.exists("./rawdata/NUTS_2013_01M_SH/data/NUTS_RG_01M_2013.shp")){
    ...
    shape <- readOGR(dsn = "./rawdata/NUTS_2013_01M_SH/data", layer = "NUTS_RG_01M_2013", verbose=FALSE)
  } else shape <- readOGR(dsn = "./rawdata/NUTS_2013_01M_SH/data", layer = "NUTS_RG_01M_2013", verbose=FALSE)
  shape$id <- rownames(shape@data)
  map.points <- fortify(shape, region = "id")
  map.df <- merge(map.points, shape, by = "id")
  map.df <- arrange(map.df, order)
  NUTS_2013_01M_SH <- map.df
  save(NUTS_2013_01M_SH, file="./rdata/NUTS_2013_01M_SH.RData")
